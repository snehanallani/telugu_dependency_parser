#!/bin/bash
END=10
data_path=/home/sneha.nallani/parser_bert/inter/cross_validation_data/cv_data
vectors_path=/home/sneha.nallani/parser_bert/inter/cross_validation_data/cv_bert_vectors
input_data_dir=/scratch/cv_input_data
output_data_dir=/scratch/sneha_nallani/inter/cv_output
